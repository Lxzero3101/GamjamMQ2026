...
public class FkingTired2 : MonoBehaviour
{
    ...
    private IEnumerator ApplyEffect()
    {
        ...
        {
            // Remove 40% of max HP
            int damage = Mathf.RoundToInt(enemy.maxHP * 0.40f);
            enemy.currentHP = Mathf.Max(0, enemy.currentHP - damage);
            battleSystem.dialogueText.text = " Enemy lost 40% HP!";
        }
